---
title: Welcome to the OpenFirma blog
date: 2026-05-08
authors: firma
excerpt: A short note on what to expect here - release notes, design write-ups, and the occasional deep dive into how OpenFirma works under the hood.
---

This is the inaugural post for the OpenFirma blog.

We'll use this space for three things:

- **Release notes.** Every tagged release will have a companion post here summarizing what changed, what's new, and what you should know before upgrading.
