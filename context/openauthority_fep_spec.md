...
* **Out of scope for v0.1:** provenance capture runtime, replay tooling, OpenAuthority Chain audit export.
...
* Full OpenAuthority Chain audit backend — compliance-grade event export.  
...
| `openauthority/v1/types.proto` | Wire format contract | Message field definitions, types, field numbers, enums for ExecutionEnvelope, CapabilityToken, EnforcementDecision, etc. |
| `openauthority/v1/authority.proto` | RPC contract | AuthorityService method signatures: IssueCapability, WatchPolicyBundle, WatchRevocations |
