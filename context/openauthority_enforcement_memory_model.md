...
| The value of Layer 3 is not limited to runtime denial.  Post-v1 provenance enables explainability, compliance-grade audit, forensic reconstruction ("why did the system attempt this?"), and long-horizon approval chains that bind to a specific causal context rather than a single payload hash. This is the wedge between OSS runtime enforcement and the proprietary OpenAuthority intelligence layer. |
| :---- |
...
| OpenAuthority OSS v1 — runtime enforcement | OpenAuthority proprietary — provenance \+ replay intelligence |
| :---- | :---- |
