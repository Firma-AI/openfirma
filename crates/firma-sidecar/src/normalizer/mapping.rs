...
impl MappingTable {
    ...
    pub fn from_config(
        ...
        // Duplicate (method, host, path) tuple detection. Two rules with the
        // same triple across merged mapping files produces ambiguous
        // classification → fail-closed at startup.
