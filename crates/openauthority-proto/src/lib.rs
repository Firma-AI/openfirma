// OpenAuthority Proto — gRPC service definitions and wire contract types.
//
// This crate is the single source of truth for the OpenAuthority wire contract.
...
pub mod openauthority {
    pub mod v1 {
        tonic::include_proto!("openauthority.v1");
    }
}

// Re-export commonly used types at crate root for ergonomics.
pub use openauthority::v1::*;
