...
//! trait and its implementations stay inside `openauthority-sidecar` because
//! they are consumed only by the enforcement pipeline.
//!
//! [`CredentialInjector`]: https://docs.rs/openauthority-sidecar/latest/openauthority_sidecar/credential/trait.CredentialInjector.html
...
/// ```
/// use std::collections::HashMap;
/// use openauthority_core::InjectedCredentials;
///
