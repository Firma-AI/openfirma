...
//!
//! This crate compiles the `.proto` definitions under `proto/firma/v1/` into
//! Rust types and Tonic service glue. It is the single source of truth for the
//! Authority, Sidecar, and audit wire formats in `OpenFirma` and Firma Team.
//!
