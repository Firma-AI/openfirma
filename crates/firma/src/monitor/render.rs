...
mod tests {
    ...
    const ALLOW_LINE_WITH_SANDBOX: &str = r#"{"event_id":"e4","session_id":"s","token_id":"t","agent_id":"demo-1","action":"github.issue.create","resource":"api.github.com/repos/x/y/issues","decision":1,"deny_reason":"","enforcement_latency_us":150,"context_hash":"","bundle_version":"","timestamp":1715177755000000000,"dispatch_status":201,"dispatch_latency_us":42000,"response_size":128,"sandbox_id":"sbx_01j0000000e008000000000001","signature":[]}"#;

    #[test]
    fn pretty_audit_appends_sandbox_when_present() {
        let out = render_to_string(ALLOW_LINE_WITH_SANDBOX, Source::Audit, Format::Pretty);
        insta::assert_snapshot!(out, @"2024-05-08T14:15:55Z  ALLOW    -  api.github.com/repos/x/y/issues  class=github.issue.create  agent=demo-1  sandbox=sbx_01j0000000e008000000000001");
    }
