...
use openauthority_sidecar::{args, config, handler, health, log, startup};
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::debug!("openauthority-sidecar starting");
    ...
    tracing::debug!("openauthority-sidecar exiting");
