...
use openauthority_grpc_interceptor_proto::interceptor_hook_server::{
    InterceptorHook, InterceptorHookServer,
};
use openauthority_grpc_interceptor_proto::{InterceptRequest, InterceptResponse};
...
impl InterceptorHook for GrpcInterceptor {
    async fn intercept(
        ...
        let metadata_session_id = metadata
            .get("x-openauthority-session-id")
...
mod tests {
    ...
    use openauthority_grpc_interceptor_proto::interceptor_hook_client::InterceptorHookClient;
