...
use openauthority_core::token::matches_resource_scope;
use openauthority_core::{AgentId, CapabilityClaims, DenyReason};
...
///
/// The sidecar uses this trait rather than openauthority-core's `PolicyEvaluator`
    ...
    fn test_envelope_with_resource(action_class: &str, resource: &str) -> NormalizedEnvelope {
        NormalizedEnvelope {
            intent: ExecutionIntent {
                ...
                resource: openauthority_core::ExecutionIntent::resource_map_from(resource),
