...
//!    `OpenAuthority`; the sidecar selects the correct token internally.
...
use openauthority_core::{CapabilityClaims, RevocationStore, TokenError, TokenVerifier};
...
mod tests {
    ...
    use chrono::Utc;
    use openauthority_core::CapabilityClaims;
    ...
    fn test_invalid_signature_denied() {
        ...
        assert_eq!(
            ...
            Some(openauthority_core::DenyReason::TokenInvalid)
        );
    }
    ...
    fn test_revoked_token_denied() {
        ...
        assert_eq!(
            decision.deny_reason(),
            Some(openauthority_core::DenyReason::TokenRevoked)
        );
    }
    ...
    fn test_expired_token_denied() {
        ...
        assert_eq!(
            decision.deny_reason(),
            Some(openauthority_core::DenyReason::TokenExpired)
        );
    }
    ...
    fn test_enforce_selects_and_validates_token() {
        ...
        let envelope = NormalizedEnvelope {
            intent: openauthority_core::ExecutionIntent {
                action_class: "communication.external.send".to_string(),
                resource: openauthority_core::ExecutionIntent::resource_map_from(
                    "api.openai.com/v1/chat",
                ),
                params: openauthority_core::ActionParams::Http(openauthority_core::HttpParams {
                    method: openauthority_core::HttpMethod::POST,
    ...
    fn test_enforce_no_matching_token_denies() {
        ...
        let envelope = NormalizedEnvelope {
            intent: openauthority_core::ExecutionIntent {
                ...
                resource: openauthority_core::ExecutionIntent::resource_map_from("any.resource"),
                params: openauthority_core::ActionParams::Http(openauthority_core::HttpParams {
                    method: openauthority_core::HttpMethod::DELETE,
                    headers: std::collections::HashMap::new(),
                    body: None,
                    query: std::collections::HashMap::new(),
                }),
