...
//!
//! Holds the set of [`Connector`](openauthority_core::Connector) implementations
...
use openauthority_core::Connector;
...
mod tests {
    ...
    use openauthority_core::{Connector, ConnectorError, ConnectorResponse, TransportView};
