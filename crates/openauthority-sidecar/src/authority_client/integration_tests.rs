...
use openauthority_core::{AgentId, RevocationStore, TokenId};
use openauthority_proto::authority_service_server::{AuthorityService, AuthorityServiceServer};
use openauthority_proto::{
...
/// and lives at `crates/openauthority-authority/schema.cedarschema` (embedded in the binary).
