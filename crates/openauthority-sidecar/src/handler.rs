...
pub(crate) mod tests {
    ...
    fn denial_context_of_tooluse_envelope_is_tool() {
        use openauthority_core::ToolUseParams;
        let envelope = NormalizedEnvelope {
            intent: ExecutionIntent {
                action_class: "tool.generic".to_string(),
                resource: openauthority_core::ExecutionIntent::resource_map_from("my_tool"),
    ...
    fn denial_context_of_dbquery_envelope_is_api() {
        use openauthority_core::DbQueryParams;
        let envelope = NormalizedEnvelope {
            intent: ExecutionIntent {
                action_class: "credential.read".to_string(),
                resource: openauthority_core::ExecutionIntent::resource_map_from("pg://orders"),
