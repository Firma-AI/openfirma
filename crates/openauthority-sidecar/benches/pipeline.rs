...
use openauthority_core::{CapabilityClaims, RevocationStore, TokenError, TokenId, TokenVerifier};
use openauthority_sidecar::config::{MappingRuleConfig, MappingRulesFile};
use openauthority_sidecar::credential::NullCredentialInjector;
use openauthority_sidecar::enforcement::capability_map::{CapabilityEntry, CapabilityMap};
use openauthority_sidecar::enforcement::capability_validation::CapabilityValidator;
use openauthority_sidecar::enforcement::cedar_evaluator::CedarPolicyEvaluator;
use openauthority_sidecar::enforcement::constraint_enforcement::ConstraintEnforcer;
use openauthority_sidecar::enforcement::registry::ActionClassRegistry;
use openauthority_sidecar::enforcement::session_state::LruSessionStateStore;
use openauthority_sidecar::normalizer::{IntentNormalizer, MappingTable, RawRequest};
use openauthority_sidecar::pipeline::{EnforcementPipeline, PipelineArgs};
...
fn build_pipeline() -> EnforcementPipeline {
    ...
    let evaluator: Arc<
        dyn openauthority_sidecar::enforcement::constraint_enforcement::PolicyEvaluation,
    > = Arc::new(
