...
use openauthority_proto::openauthority::v1::authority_service_client::AuthorityServiceClient;
...
use openauthority_authority::{AuthorityConfig, Server};
...
async fn watch_revocations_streams_new_events() {
    ...
    let token_id = openauthority_core::token::TokenId::new();
