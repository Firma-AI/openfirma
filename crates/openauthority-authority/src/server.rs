...
use openauthority_proto::openauthority::v1::authority_service_server::AuthorityServiceServer;
...
impl Server {
        ...
        F: Future<Output = ()> + Send + 'static,
    {
        tracing::info!(
            ...
            "openauthority-authority starting"
        );
        tracing::warn!(
            "NOT FOR PRODUCTION USE: This is the Mini Authority (OpenAuthority OSS v1) intended for local development and testing only."
        );
